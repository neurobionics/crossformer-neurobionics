...
class CrossFormerTransformer(nn.Module):
    """
    This module forms the base of the CrossFormer architecture.
...
class CrossFormerModule(nn.Module):
    """
    Bundles CrossFormerTransformer with various heads (useful for keeping all parameters in one place).
    """
    ...
    def __call__(
        ...
        Args:
            ...
            verbose: If True, prints out the structure of the CrossFormerTransformer (useful for debugging!)

        Returns:
            transformer_outputs: See CrossFormerTransformer.__call__
            head_outputs: dictionary of outputs from heads {head_name: output}
        """
        transformer_outputs = self.crossformer_transformer(
    ...
    def create(
        ...
        model_def = CrossFormerTransformer(
        ...
        return cls(
            crossformer_transformer=model_def,
            heads=head_defs,
        )
